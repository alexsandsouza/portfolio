...
// ─── MAIN LEADERBOARD ────────────────────────────────────────────────────────
export default function RankingM5A03() {
  ...
  useEffect(() => {
    ...
    const unsubscribe = onSnapshot(q, (snapshot) => {
      ...
      loaded = loaded.filter(doc => doc.module === "M05_A03");
  ...
  async function clearAll() {
    try {
      ...
      const deletePromises = snapshot.docs
        .filter(document => document.data().module === "M05_A03")
    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ maxWidth: 900, margin: "0 auto" }}>
          ...
          <div style={{ marginTop: 10, fontSize: 12, color: "rgba(255,255,255,0.3)" }}>
            Prof. Alexsander Farias · Soluções de Autorização
          </div>
        </div>
      </div>
      ...
      <div style={{ maxWidth: 900, margin: "0 auto", padding: "24px 20px" }}>
        ...
        <div style={{ textAlign: "center", marginTop: 32, fontSize: 11, color: "rgba(255,255,255,0.15)", fontFamily: "'Space Mono', monospace" }}>
          Ranking M5A03 · Prof. Alexsander Farias · Hackers do Bem
        </div>
      </div>
