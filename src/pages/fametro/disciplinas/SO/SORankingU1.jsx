...
export default function SORankingU1() {
  ...
  useEffect(() => {
    ...
    const unsub = onSnapshot(q, (snapshot) => {
      ...
      loaded = loaded.filter(d => d.activityId === "so_unidade1");
  ...
  async function clearAll() {
    try {
      ...
      const dels = snapshot.docs
        .filter(d => d.data().activityId === "so_unidade1")
    ...
    <div style={{
      ...
      <div style={{ maxWidth: 900, margin: "0 auto" }}>
        ...
        <div style={{ textAlign: 'center', marginBottom: 40 }}>
           ...
           <h1 style={{ fontSize: 36, fontWeight: 900, margin: 0 }}>📊 Ranking — SO Quest Unidade I</h1>
           <p style={{ color: '#94A3B8' }}>Unidade I · Introdução aos SOs e Conceitos de Hardware</p>
        </div>
