...
import { QUESTIONS_A, QUESTIONS_B, STUDY_CASE_A, STUDY_CASE_B } from "../../../../data/pooSimuladoData";
// â”€â”€â”€ STYLING SYSTEM â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
const theme = {
  bg: "#070B14",
  surface: "#0F172A",
...
function renderQuestionText(text) {
  return text.split('\n\n').map((para, paraIdx) => {
    ...
    const isQuestion = para.startsWith("**QuestÃ£o:**") || para.startsWith("QuestÃ£o:");
    ...
    if (isContext) {
      ...
      title = "O DESAFIO TÃ‰CNICO";
      borderLeft = "4px solid #FBBF24";
      background = "rgba(251, 191, 36, 0.02)";
      borderColor = "rgba(251, 191, 36, 0.1)";
    } else if (isQuestion) {
      content = para.replace(/^\*\*QuestÃ£o:\*\*\s*/, "").replace(/^QuestÃ£o:\s*/, "");
      title = "ENUNCIADO DA QUESTÃƒO";
...
// â”€â”€â”€ WELCOME SUB-COMPONENT â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    <div className="simulado-welcome-card" style={{
      ...
      <div style={{ position: "relative", zIndex: 1 }}>
        ...
        <div style={{
          ...
          <div><strong>Curso:</strong> AnÃ¡lise e Desenvolvimento de Sistemas</div>
          <div><strong>Disciplina:</strong> Linguagem de ProgramaÃ§Ã£o Orientada a Objetos</div>
          <div><strong>Professor:</strong> Alexsander Farias</div>
          <p style={{ marginTop: "0.75rem" }}>
            Seja bem-vindo ao simulado N2. Teste seus conhecimentos em concorrÃªncia, Swing, SOLID e estruturas de dados sob a Ã³tica de engenharia de software e padrÃµes de projeto.
          </p>
        </div>
        ...
        <div style={{
          ...
          {[
            { label: "MÃºltipla Escolha", val: "8 questÃµes (0,75 cada)" },
            { label: "Discursiva", val: "1 questÃ£o (4,0 pontos)" },
            { label: "PontuaÃ§Ã£o Total", val: "10,0 pontos" },
            { label: "CronÃ´metro", val: "Tempo Real" }
          ].map(item => (
        ...
        <form onSubmit={handleSubmit} style={{ maxWidth: "440px", margin: "0 auto", textAlign: "left" }}>
          ...
          <div style={{ marginBottom: "2rem" }}>
            ...
            >
              ðŸ’¡ Aula PreparatÃ³ria Interativa (Aprender Conceitos)
            </button>
...
export default function SimuladoN2() {
  ...
  const handleFinishExam = async () => {
    ...
    if (unansweredCount > 0) {
      const confirmSubmit = window.confirm(`VocÃª possui ${unansweredCount} questÃµes objetivas sem resposta. Deseja finalizar assim mesmo?`);
      if (!confirmSubmit) return;
    } else if (!discursiveAnswer.trim()) {
      const confirmSubmit = window.confirm("Sua resposta discursiva estÃ¡ em branco. Deseja finalizar o simulado mesmo assim?");
      if (!confirmSubmit) return;
    } else if (Object.values(discursiveCriteria).some(val => val === null)) {
      alert("Por favor, preencha todos os 4 critÃ©rios da autoavaliaÃ§Ã£o discursiva antes de finalizar.");
      return;
    } else {
                    ...
                    <div className="simulado-question-card" style={{
                      ...
                      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "1.25rem" }}>
                        ...
                        <span style={{ fontSize: "0.85rem", color: theme.textMuted }}>
                          QuestÃ£o {activeQuestionIdx + 1} de {totalQuestions + 1}
                        </span>
                      </div>
                ...
                <div className="simulado-question-card" style={{
                  ...
                  <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "1rem" }}>
                    <span style={{
                      ...
                      Estilo ENADE Â· Discursiva
                    </span>
                    <span style={{ fontSize: "0.85rem", color: theme.textMuted }}>
                      QuestÃ£o {totalQuestions + 1} de {totalQuestions + 1}
                    </span>
                  </div>
                  ...
                  <div style={{ marginBottom: "1rem" }}>
                    <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "8px" }}>
                      <label style={{ fontSize: "0.85rem", color: theme.white, fontWeight: 600 }}>
                        Texto de Resposta do Estudante (mÃ­nimo de 30 linhas)
                      </label>
                      <span style={{ 
                        fontSize: "0.75rem", 
                    ...
                    <textarea
                      ...
                      placeholder="Redija sua anÃ¡lise dissertativa-argumentativa fundamentando tecnicamente as soluÃ§Ãµes com base nos princÃ­pios de arquitetura de software, SOLID, Design Patterns e concorrÃªncia no Java..."
                      style={{
                        width: "100%",
                        height: "280px",
                        padding: "1.25rem",
                  ...
                  {calculateTextareaLines() < 30 && (
                    <div style={{
                      ...
                      <AlertTriangle size={14} /> Recomendamos que desenvolva melhor a sua argumentaÃ§Ã£o tÃ©cnica para atingir a meta pedagÃ³gica de 30 linhas.
                    </div>
                  )}
                  ...
                  <div style={{ marginTop: "2rem", borderTop: `1px solid ${theme.border}`, paddingTop: "1.5rem", display: "flex", justifyContent: "flex-end" }}>
                    {!showCriteria ? (
                      ...
                      >
                        Revelar CritÃ©rios e Gabarito de CorreÃ§Ã£o
                      </button>
                    ) : (
                      <div style={{
                        width: "100%",
                        ...
                        <h4 style={{ color: theme.success, margin: "0 0 1rem", fontSize: "0.95rem", fontWeight: 800 }}>
                          âœ“ DIRETRIZES E GABARITO OFICIAL DO PROFESSOR:
                        </h4>
                        <div style={{
                          fontSize: "0.9rem",
                          lineHeight: 1.6,
                        ...
                        {/* Painel de AutoavaliaÃ§Ã£o da Discursiva */}
                        <div style={{
                          ...
                          <h4 style={{ color: "#FBBF24", margin: "0 0 0.5rem", fontSize: "0.95rem", fontWeight: 800 }}>
                            â­ AUTOAVALIAÃ‡ÃƒO INSTRUCIONAL:
                          </h4>
                          <p style={{ fontSize: "0.85rem", color: theme.textMuted, margin: "0 0 1.5rem" }}>
                            Com base nas diretrizes do gabarito acima, avalie sua resposta para cada um dos 4 requisitos tÃ©cnicos da questÃ£o discursiva:
                          </p>

                          <div style={{ display: "flex", flexDirection: "column", gap: "1.25rem" }}>
                            {[
                              { key: "A", label: "A) DiagnÃ³stico de SOLID & Riscos TÃ©cnicos (1,0 ponto)", desc: "Identificou a violaÃ§Ã£o do SRP e OCP na classe central e os riscos tÃ©cnicos e de negÃ³cio." },
                              { key: "B", label: "B) Proposta de Design Pattern (1,0 ponto)", desc: "PropÃ´s o padrÃ£o Strategy (ou State/Factory para o Modelo B) com composiÃ§Ã£o para eliminar condicionais." },
                              { key: "C", label: "C) ConcorrÃªncia & Estruturas de Dados (1,0 ponto)", desc: "Explicou a inadequaÃ§Ã£o da ArrayList em ambientes multi-thread e sugeriu uma fila thread-safe robusta." },
                              { key: "D", label: "D) VisÃ£o EstratÃ©gica do Profissional (1,0 ponto)", desc: "Abordou a habilidade de criar soluÃ§Ãµes escalÃ¡veis, reduzir a dÃ­vida tÃ©cnica e apoiar a receita da empresa." }
                            ].map(criterion => {
                              ...
                              return (
                                <div key={criterion.key} style={{
                                  ...
                                  <div style={{ display: "flex", gap: "8px" }}>
                                    {[
                                      { value: 0.0, label: "NÃ£o atendeu (0.0)" },
                  ...
                  <div style={{ display: "flex", flexDirection: "column", alignItems: "flex-end" }}>
                    ...
                    {activeQuestionIdx === totalQuestions && showCriteria && Object.values(discursiveCriteria).some(val => val === null) && (
                      <span style={{ fontSize: "0.75rem", color: "#FBBF24", marginTop: "6px", fontWeight: 600 }}>
                        * Preencha os 4 critÃ©rios da autoavaliaÃ§Ã£o discursiva.
                      </span>
                    )}
                  </div>
                )}
              ...
              <div className="simulado-nav-card" style={{
                ...
                <div style={{
                  ...
                  <div style={{ display: "flex", alignItems: "center", gap: "6px" }}>
                    <span style={{ width: "8px", height: "8px", borderRadius: "50%", backgroundColor: theme.textMuted }} /> NÃ£o respondido
                  </div>
                  <div style={{ display: "flex", alignItems: "center", gap: "6px" }}>
        ...
        {step === 2 && (
          <div style={{ animation: "fadeIn 0.6s ease-out" }}>
            ...
            <div className="simulado-report-card" style={{
              ...
              <div style={{ fontSize: "50px", marginBottom: "0.5rem" }}>ðŸŽ“</div>
              ...
              <p style={{ color: theme.textMuted, fontSize: "0.95rem", margin: "0 0 2rem" }}>
                ParabÃ©ns, <strong>{name}</strong>. Sua nota foi processada e enviada para o ranking do <strong>Modelo {model}</strong>.
              </p>
              ...
              <div style={{ display: "flex", justifyContent: "center", gap: "1rem", flexWrap: "wrap", marginBottom: "1.5rem" }}>
                ...
                {saveStatus === "saved" && (
                  <div style={{ fontSize: "0.8rem", color: theme.success }}>âœ“ PontuaÃ§Ã£o registrada e integrada ao ranking geral de POO.</div>
                )}
                {saveStatus === "error" && (
                  <div style={{ fontSize: "0.8rem", color: theme.danger }}>âš  Falha de conexÃ£o. Imprima seu relatÃ³rio para validaÃ§Ã£o do professor.</div>
                )}
              </div>
            ...
            <div className="simulado-correction-card" style={{
              ...
              <h3 style={{
                ...
                CorreÃ§Ã£o Detalhada das QuestÃµes (Modelo {model})
              </h3>
                  ...
                  return (
                    ...
                    >
                      ...
                      <div style={{
                        ...
                        <strong style={{ color: theme.white, display: "block", marginBottom: "4px" }}>ExplicaÃ§Ã£o PedagÃ³gica:</strong>
                        {q.feedback}
                      </div>
