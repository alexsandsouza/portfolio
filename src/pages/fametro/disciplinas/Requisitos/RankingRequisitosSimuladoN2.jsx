...
export default function RankingRequisitosSimuladoN2() {
  ...
  useEffect(() => {
    ...
    const unsub = onSnapshot(q, (snapshot) => {
      ...
      loaded = loaded.filter(d => d.activityId === "requisitos_simulado_n2");
  ...
  async function clearAll() {
    ...
    try {
      ...
      const dels = snapshot.docs
        .filter(d => d.data().activityId === "requisitos_simulado_n2")
  ...
  return (
    <div style={{
      ...
      {/* Glow Effects */}
      <div style={{ position: 'fixed', inset: 0, backgroundImage: 'radial-gradient(ellipse at 10% 50%, rgba(239,68,68,0.06) 0%, transparent 60%), radial-gradient(ellipse at 80% 20%, rgba(167,139,250,0.04) 0%, transparent 50%)', pointerEvents: 'none', zIndex: 0 }} />
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 16 }}>
            ...
            <div>
              <div style={{ fontSize: 9, letterSpacing: 3, color: "#EF4444", fontFamily: "monospace", textTransform: 'uppercase' }}>
                FAMETRO · Engenharia de Requisitos · Simulado N2
              </div>
                ...
                <div key={entry.id} style={{
                  ...
                  <div>
                    ...
                    <div style={{ fontSize: 10, color: "#64748B", marginTop: 2 }}>
                      Simulado N2 - Engenharia de Requisitos
                    </div>
                  </div>
