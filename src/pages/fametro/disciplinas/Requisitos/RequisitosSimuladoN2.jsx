...
import { QUESTIONS_A, QUESTIONS_B, STUDY_CASE_A, STUDY_CASE_B } from "../../../../data/requisitosSimuladoData";
...
const theme = {
  ...
  borderActive: "#EF4444", // Vermelho para combinar com o tema do Prof. Alexsander Farias
  accent: "#EF4444",
    ...
    <div className="simulado-welcome-card" style={{
      ...
      <div style={{ position: "relative", zIndex: 1 }}>
        ...
        <h1 style={{
          ...
          Simulado Acadêmico · Engenharia de Requisitos
        </h1>
        ...
        <div style={{
          ...
          <div><strong>Disciplina:</strong> Engenharia de Requisitos</div>
          <div><strong>Professor:</strong> Alexsander Farias</div>
          <p style={{ marginTop: "0.75rem" }}>
            Seja bem-vindo ao simulado N2. Teste seus conhecimentos em elicitação, modelagem, verificação, validação, reuso e rastreabilidade sob a ótica de engenharia de software e gestão de mudanças de escopo.
          </p>
        </div>
...
// ─── MAIN COMPONENT ──────────────────────────────────────────────────────────
export default function RequisitosSimuladoN2() {
  ...
  const handleFinishExam = async () => {
    ...
    try {
      await addDoc(collection(db, "fametro_ranking"), {
        ...
        activityId: "requisitos_simulado_n2",
        model: `Modelo ${model}`,
        module: "Engenharia de Requisitos",
                ...
                <div className="simulado-question-card" style={{
                  ...
                  <div style={{ marginBottom: "1rem" }}>
                    ...
                    <textarea
                      ...
                      placeholder="Redija sua análise dissertativa-argumentativa fundamentando tecnicamente seu diagnóstico de gerência de requisitos, reuso, rastreabilidade bidirecional, análise de impacto e a transição para um modelo controlado e escalável..."
                      style={{
                        width: "100%",
                        height: "280px",
                        padding: "1.25rem",
                      ...
                      <div style={{
                        ...
                        <div style={{
                          ...
                          <div style={{ display: "flex", flexDirection: "column", gap: "1.25rem" }}>
                            {[
                              { key: "A", label: "A) Diagnóstico de Gerência (1,0 ponto)", desc: "Apontou falhas de gerência (baseline, versionamento, controle de mudanças) e riscos de retrabalho e inconsistências regulatórias." },
                              { key: "B", label: "B) Estratégia de Reutilização (1,0 ponto)", desc: "Propôs técnicas de reuso adequadas (catálogos de requisitos, requisitos parametrizáveis ou LPS) para reduzir esforço e custo." },
                              { key: "C", label: "C) Rastreabilidade e Controle de Mudança (1,0 ponto)", desc: "Definiu uma solução baseada em matriz de rastreabilidade bidirecional conectando os requisitos com componentes e testes." },
                              { key: "D", label: "D) Visão Sistêmica e Inovação (1,0 ponto)", desc: "Argumentou como a engenharia de requisitos madura prepara o sistema para evoluções futuras estáveis (como microsserviços, IA ou IoT)." }
                            ].map(criterion => {
          ...
          <div style={{ animation: "fadeIn 0.6s ease-out" }}>
            ...
            <div className="simulado-report-card" style={{
              ...
              <div style={{ display: "flex", justifyContent: "center", gap: "1rem", flexWrap: "wrap", marginBottom: "1.5rem" }}>
                ...
                {saveStatus === "saved" && (
                  <div style={{ fontSize: "0.8rem", color: theme.success }}>✓ Pontuação registrada e integrada ao ranking de Engenharia de Requisitos.</div>
                )}
                {saveStatus === "error" && (
              ...
              <div style={{
                ...
                <Link
                  to="/fametro/requisitos/simulado-n2/ranking"
                  style={{
                    display: "inline-flex",
                    alignItems: "center",
                    gap: "8px",
