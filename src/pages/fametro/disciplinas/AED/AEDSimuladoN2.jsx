...
import { QUESTIONS_A, QUESTIONS_B, STUDY_CASE_A, STUDY_CASE_B } from "../../../../data/aedSimuladoData";
...
const theme = {
  ...
  borderActive: "#6366F1", // Indigo para combinar com o tema de AED no Hub
  accent: "#6366F1",
    ...
    <div className="simulado-welcome-card" style={{
      ...
      <div style={{ position: "relative", zIndex: 1 }}>
        ...
        <h1 style={{
          ...
          Simulado Acadêmico · Algoritmos e Estrutura de Dados I
        </h1>
        ...
        <div style={{
          ...
          <div><strong>Curso:</strong> Engenharia de Computação</div>
          <div><strong>Disciplina:</strong> Algoritmos e Estrutura de Dados I</div>
          <div><strong>Professor:</strong> Alexsander Farias</div>
          <p style={{ marginTop: "0.75rem" }}>
            Seja bem-vindo ao simulado N2 de AED I. Teste seus conhecimentos práticos e teóricos em linguagem C sobre passagem por referência com ponteiros, aritmética de ponteiros, alocação de memória (Heap vs Stack), structs, manipulação de arquivos de texto e listas encadeadas.
          </p>
        </div>
...
// ─── MAIN COMPONENT ──────────────────────────────────────────────────────────
export default function AEDSimuladoN2() {
  ...
  const handleFinishExam = async () => {
    ...
    try {
      await addDoc(collection(db, "fametro_ranking"), {
        ...
        activityId: "aed_simulado_n2",
        model: `Modelo ${model}`,
        module: "Algoritmos e Estrutura de Dados I",
                ...
                <div className="simulado-question-card" style={{
                  ...
                  <div style={{ marginBottom: "1rem" }}>
                    ...
                    <textarea
                      ...
                      placeholder="Redija seu parecer técnico-argumentativo em linguagem C propondo a nova arquitetura dinâmica: Fila para processamento FIFO de telemetrias, Pilha para logs de erro LIFO cronológicos reversos, Lista Encadeada para drones em manutenção com remoções eficientes e as vantagens de resiliência e prevenção de buffer overflow..."
                      style={{
                        width: "100%",
                        height: "280px",
                        padding: "1.25rem",
                      ...
                      <div style={{
                        ...
                        <div style={{
                          ...
                          <div style={{ display: "flex", flexDirection: "column", gap: "1.25rem" }}>
                            {[
                              { key: "A", label: "A) Crítica a Vetores e Fila FIFO (1,0 ponto)", desc: "Apontou os problemas dos vetores estáticos e defendeu a estrutura de Fila dinâmica para telemetria FIFO ordenada." },
                              { key: "B", label: "B) Logs em Estrutura LIFO (1,0 ponto)", desc: "Propôs a estrutura de Pilha para ordenação cronológica reversa LIFO de erros com operações push/pop." },
                              { key: "C", label: "C) Lista para Remoções Aleatórias (1,0 ponto)", desc: "Explicou o uso de Listas Encadeadas para remoção de nós intermediários sem deslocamentos e detalhou ponteiros." },
                              { key: "D", label: "D) Integração e Resiliência (1,0 ponto)", desc: "Analisou a segurança da nova arquitetura dinâmica contra Buffer Overflow e travamento físico na memória Heap." }
                            ].map(criterion => {
          ...
          <div className="simulado-report-card" style={{
            ...
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "2rem" }} className="no-print">
              ...
              <div style={{ display: "flex", gap: "10px" }}>
                ...
                <Link
                  to="/fametro/aed/simulado-n2/ranking"
                  style={{
                    display: "flex",
                    alignItems: "center",
                    gap: "6px",
            ...
            <div style={{
              ...
              <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(200px, 1fr))", gap: "10px", margin: "1rem 0" }}>
                {[
                  { key: "A", name: "A) Crítica a Vetores e Fila", val: discursiveCriteria.A },
                  { key: "B", name: "B) Logs em Pilha (LIFO)", val: discursiveCriteria.B },
                  { key: "C", name: "C) Remoções e Listas", val: discursiveCriteria.C },
                  { key: "D", name: "D) Resiliência e Comparação", val: discursiveCriteria.D }
                ].map(crit => (
