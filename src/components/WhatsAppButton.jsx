        ...
        >
            ...
            <style>{`
                .whatsapp-float {
                    ...
                    height: 50px;
                    bottom: 100px; 
                    right: 2rem; /* Exact match with Theme Toggle (32px) */
                ...
                @keyframes pulseBtn {
                    ...
                    70% { box-shadow: 0 0 0 10px rgba(37, 211, 102, 0); } /* Reduced pulse size */
                ...
                @media (max-width: 768px) {
                    .whatsapp-float {
                        width: 45px;
                        height: 45px;
                        bottom: 95px; /* Higher to avoid overlap */
                        right: 2rem; /* Consistent alignment */
                    }
                }
            `}</style>
        </a>
